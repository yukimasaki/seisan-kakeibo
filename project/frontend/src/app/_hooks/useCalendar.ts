import { CalendarStore } from "@frontend/types/calendar";
  ...
  ({
    ...
    setSelectedMonth: (month) =>
      set((state) => ({
        ...
        start: dayjs(`${state.selectedYear}-${month}-01`)
          .startOf("month")
          .format("YYYY-MM-DD"),
        end: dayjs(`${state.selectedYear}-${month}-01`)
          .endOf("month")
          .format("YYYY-MM-DD"),
      })),
    toggleIsYearMonthPickerOpen: () =>
      set((state) => ({
